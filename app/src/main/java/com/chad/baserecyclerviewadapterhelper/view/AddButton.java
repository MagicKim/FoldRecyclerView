...
import com.chad.baserecyclerviewadapterhelper.util.ViewUtils;
...
public class AddButton extends View implements View.OnClickListener {
	...
	protected void onDraw(Canvas canvas) {
		...
		} else if (getWidth() == getContext().getResources().getDimension(R.dimen.dp_10)) {
			drawText(canvas);
		}
	}
	...
	public void expendAnim() {
		isCircle = false;
		ViewAnimator.animate(this)
				.width(getWidth(), getContext().getResources().getDimension(R.dimen.dp_10))
				.duration(300)
				.onStop(new AnimationListener.Stop() {
					@Override
					public void onStop() {
