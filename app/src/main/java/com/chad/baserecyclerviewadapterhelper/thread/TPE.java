...
import com.chad.baserecyclerviewadapterhelper.thread.task.AsyncTask;
import com.chad.baserecyclerviewadapterhelper.thread.task.Callback;
import com.chad.baserecyclerviewadapterhelper.thread.task.IPriorityTask;
import com.chad.baserecyclerviewadapterhelper.thread.task.TaskScheduler;
import com.chad.baserecyclerviewadapterhelper.thread.task.UIChangeEvent;
...
public class TPE extends ThreadPoolExecutor {
    ...
    public void submitTaskDelay(Runnable runnable, long delay) {
        Handlers.postDelayed(runnable,delay);
    }
