...
import com.chad.baserecyclerviewadapterhelper.thread.Handlers;
import com.chad.baserecyclerviewadapterhelper.thread.TPE;
...
/*package*/ abstract class AbstractTask<Result> extends FutureTask<Result> implements ITask, IGroupedTask, IPriorityTask {
            ...
            Handlers.postMain(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Log.e(TAG, "do apply onBeforeCall ex, task=" + this, e);
                    }
                }
            });
        }
    ...
    void afterExecute() {
        try {
            ...
            Log.e(TAG, "do apply onAfterCall ex, task=" + this, e);
        }
    }
    ...
    protected void done() {
            ...
            Handlers.postMain(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Log.e(TAG, "call callback ex task=" + AbstractTask.this, e);
        ...
        if (TPE.isDebug()) {
            Log.e(TAG, "task execute end, task=" + this);
        }
    }
    ...
    protected void setException(Throwable t) {
        ...
        Log.e(TAG, "execute task exception, \ntask=" + this, t);
    }
